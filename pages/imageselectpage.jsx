// ppongtok-app/pages/imageselectpage.jsx (모바일 UI/UX 최적화 완료)
        ...
        <div className={styles.pageContainer}>
            <div className={styles.contentWrapper}>
                ...
                <div className={styles.buttonGroup}>
                    <button className={styles.button} onClick={() => router.push("/imagethemepage")}>
                        테마 이미지 선택
                    </button>
            ...
            <div className={styles.navButtonContainer}>
                ...
                <button onClick={handleNext} className={`${styles.navButton} ${styles.primary}`} disabled={selectedImageCount === 0}>
                    다음으로
                </button>
            </div>
        </div>
